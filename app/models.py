...
class PersonalityCompany(models.Model):
    personality = models.ForeignKey(Personality, on_delete=models.DO_NOTHING, blank=True, null=True)
    ...
    class Meta:
        ...
        ordering = ('pk', )
        constraints = [
            models.UniqueConstraint(fields=['personality', 'company'], name="personality_company_constraint")
        ]
